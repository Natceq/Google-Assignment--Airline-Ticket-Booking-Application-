...
CREATE TABLE `booking` (
  ...
  KEY `cusID_idx` (`cusID`),
  CONSTRAINT `airlinesID` FOREIGN KEY (`airlinesID`) REFERENCES `airlines` (`airlinesID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `cusID` FOREIGN KEY (`cusID`) REFERENCES `customer` (`cusID`) ON DELETE CASCADE ON UPDATE CASCADE
